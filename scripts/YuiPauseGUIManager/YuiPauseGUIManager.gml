/// @description here
function YuiPauseGUIManager() constructor {
	...
	/**/
		var beastiary_file = yui_string_from_file("GameUI/Data/beastiary.yaml")
		var beastiary = snap_from_yui(beastiary_file);
	
		slots = beastiary.slots;
		items = beastiary.items;
	
		//array_foreach(slots, function(slot) {
		//	slot.beastiary_entry_info =
		//	{
		//		name: undefined,
		//		number: undefined,
		//		enemyname: undefined,
