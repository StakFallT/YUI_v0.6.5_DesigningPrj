...
/** /
	FontGlyphString = " !";
	FontGlyphString = FontGlyphString + chr(34);
	FontGlyphString = FontGlyphString + "#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~";
/**/
FontGlyphString = " !" + chr(34) + "#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[" + chr(92) + "]^_`abcdefghijklmnopqrstuvwxyz{|}~";
BlkyFnt = font_add_sprite_ext(fntBlockyPixel, FontGlyphString, true, 1);
